...
const CustomPromptBuilder = ({ onSwitchMode }) => {
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-gray-100 flex flex-col">
      {/* Header */}
      <header className="bg-slate-800 border-b border-gray-700 px-5 py-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="flex items-center gap-2 px-3 py-1.5 bg-slate-700 hover:bg-slate-600 border border-gray-600 rounded text-sm transition-all"
            >
      ...
      <div className="bg-slate-950 border-b border-gray-700 px-5 py-2">
        <div className="flex items-center gap-3">
      ...
      <div className="flex-1 p-5 max-w-6xl mx-auto w-full">
        <div className="flex flex-col gap-4">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <span className="text-sm text-gray-400">Target Model:</span>
              <span className="px-3 py-1 bg-slate-700 border border-gray-600 rounded text-sm">
            ...
            <div className="flex gap-2">
              <button 
                ...
                className="flex items-center gap-2 px-4 py-2 bg-slate-700 hover:bg-slate-600 border border-gray-600 rounded text-sm"
              ...
              <button 
                ...
                disabled={!customPrompt.trim()}
                className="flex items-center gap-2 px-4 py-2 bg-purple-600 hover:bg-purple-700 disabled:bg-gray-600 disabled:cursor-not-allowed rounded text-sm"
              >
          ...
          {/* Custom Prompt Input */}
          <div className="bg-slate-950 border border-gray-700 rounded-lg p-5">
...
- Accessibility considerations"
              className="w-full bg-transparent border border-gray-600 rounded p-4 text-sm resize-vertical min-h-96 focus:outline-none focus:border-purple-600 font-mono"
            />
          ...
          {showPrompt && customPrompt.trim() && (
            <div className="bg-slate-950 border border-gray-700 rounded-lg p-5">
              ...
              <div className="bg-slate-900 border border-gray-600 rounded p-4">
